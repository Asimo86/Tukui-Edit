...
TukuiShift:SetWidth(58)
TukuiShift:SetHeight(29)
...
ShapeshiftBarFrame:SetFrameLevel(3)
ShapeshiftButton1:ClearAllPoints()
ShapeshiftButton1:SetHeight(TukuiDB.Scale(29))
ShapeshiftButton1:SetWidth(TukuiDB.Scale(29))
ShapeshiftButton1:SetPoint("BOTTOMLEFT", TukuiShift, 0, TukuiDB.Scale(27))
local function MoveShapeshift()
	ShapeshiftButton1:SetPoint("BOTTOMLEFT", TukuiShift, -TukuiDB.Scale(29), 0)
end
...
for i=2, 4 do
	...
	b:ClearAllPoints()
	b:SetPoint("TOP", b2, "BOTTOM",0, -TukuiDB.petbuttonspacing+1)
end

for i=5, 10 do
	local bcol1 = _G["ShapeshiftButton"..i-4]
	local b = _G["ShapeshiftButton"..i]
	b:ClearAllPoints()
	b:SetPoint("LEFT", bcol1, "RIGHT", TukuiDB.petbuttonspacing+1, 0)
end
